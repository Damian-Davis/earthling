...
const serer =http.createSever((request, response) => {
...
break 
      ...
      // TODO: Pipe 404.html to response  All of these were up above


})
  
server.listen(4001, () => {
  console.log(`Server is listening on: https://localhost:${server.adress().port}`); 
})
